...
namespace DAL.Migrations
{
    ...
    [Migration("20200529071653_AddRelationsToBooksHistory")]
    partial class AddRelationsToBooksHistory
    {
            ...
            modelBuilder.Entity("DAL.Models.Books", b =>
                {
                    b.HasOne("DAL.Models.Genres", "Genres")
                        .WithOne()
                        .HasForeignKey("DAL.Models.Books", "GenresId")
            ...
            modelBuilder.Entity("DAL.Models.BooksHistory", b =>
                {
                    b.HasOne("DAL.Models.Books", "Books")
                        .WithOne()
                        .HasForeignKey("DAL.Models.BooksHistory", "BooksId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DAL.Models.Users", "Users")
                        .WithOne()
                        .HasForeignKey("DAL.Models.BooksHistory", "UsersId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DAL.Models.Users", b =>
                {
                    b.HasOne("DAL.Models.Roles", "Roles")
                        .WithOne()
                        .HasForeignKey("DAL.Models.Users", "RolesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
